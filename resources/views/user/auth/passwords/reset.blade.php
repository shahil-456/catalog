@extends('layouts.user.master-without-nav')
@section('title')
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="{{'/'}}" class="d-inline-block auth-logo">
                                    <img src="{{ URL::asset('build/images/logo-light.png') }}" alt="" height="70">
                                </a>
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Reset password with Softcods</p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            </script> Amar. Crafted with <i
                                    class="mdi mdi-heart text-danger"></i> by Softcods</p>
                        </div>
                    </div>
                </div>
            </div>

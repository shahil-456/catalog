...
<head>
  ...
  <link href="{{ URL::to('knorix/assets/css/icons.min.css') }}" rel="stylesheet" type="text/css">
            ...
            <div class="card-body">
                <div class="flex items-center">
                    ...
                    <div class="flex-grow truncate ms-2">
                        <h5 class="text-sm font-semibold mb-1">${doneBy} <small class="font-normal text-gray-500 ms-1">${time}</small></h5>
...
<body>
        ...
        <div class="app-menu">
            ...
            <a href="index.html" class="logo-box">
                ...
                <div class="logo-light">
                    <img src="{{ URL::to('knorix/assets/images/logo-light.png') }}" class="logo-lg h-6" alt="Light logo">
                    <img src="{{ URL::to('knorix/assets/images/logo-sm.png') }}" class="logo-sm" alt="Small logo">
                </div>

                <!-- Dark Brand Logo -->
                <div class="logo-dark">
                    <img src="{{ URL::to('knorix/assets/images/logo-dark.png') }}" class="logo-lg h-6" alt="Dark logo">
                    <img src="{{ URL::to('knorix/assets/images/logo-sm.png') }}" class="logo-sm" alt="Small logo">
                </div>
            </a>
            ...
            <div class="srcollbar" data-simplebar>
                <ul class="menu" data-fc-type="accordion">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('catalogs') }}" class="menu-link">
                            <span class="menu-icon"><i class="mgc_calendar_line"></i></span>
                            <span class="menu-text"> Catelogs </span>
                        </a>
                    </li>
            ...
            <header class="app-header flex items-center px-4 gap-3">
                ...
                <div class="relative">
                    <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link p-2 fc-dropdown">
                        <span class="flex items-center justify-center h-6 w-6">
                            <img src="{{ URL::to('knorix/assets/images/flags/us.jpg') }}" alt="user-image" class="h-4 w-6">
                        </span>
                    </button>
                    <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-0 w-40 z-50 mt-2 transition-[margin,opacity] duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2">
                        ...
                        <a href="javascript:void(0);" class="flex items-center gap-2.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                            <img src="{{ URL::to('knorix/assets/images/flags/germany.jpg') }}" alt="user-image" class="h-4">
                ...
                <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link p-2 relative">
                    ...
                    <span id="notify-count"
                        class="absolute top-0 end-0 inline-flex items-center py-0.5 px-1.5 
                                rounded-full text-xs font-medium transform -translate-y-1/2 translate-x-1/2 
                                bg-rose-500 text-white">
                    </span>
                </button>

                <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-0 w-80 z-50 mt-2 
                            transition-[margin,opacity] duration-300 bg-white dark:bg-gray-800 
                    ...
                    <!-- 🔽 Notifications list -->
                    <div id="notificationsList" class="p-4 h-80 overflow-y-auto" data-simplebar>
                        <!-- JS will prepend notifications here -->
                    </div>

                    <a href="javascript:void(0);" 
                    class="p-2 border-t border-dashed border-gray-200 dark:border-gray-700 block 
                            text-center text-primary underline font-semibold">
                        View All
                    </a>
                </div>
            </div>
                ...
                <div class="relative">
                    <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link">
                        <img src="{{ URL::to('knorix/assets/images/users/user-6.jpg') }}" alt="user-image" class="rounded-full h-10">
                    </button>
    ...
    <!-- Plugin Js -->
<script src="{{ URL::to('knorix/assets/libs/simplebar/simplebar.min.js') }}"></script>

<script src="{{ URL::to('knorix/assets/libs/feather-icons/feather.min.js') }}"></script>

<script src="{{ URL::to('knorix/assets/libs/%40frostui/tailwindcss/frostui.js') }}"></script>


    <!-- App Js -->
<script src="{{ URL::to('knorix/assets/js/app.js') }}"></script>

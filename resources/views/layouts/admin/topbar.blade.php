@php
    ...
    $avatarUrl = 'https://eu.ui-avatars.com/api/?name=' . urlencode($name) . '&size=128&background=random&color=fff';
@endphp
            ...
            <div class="d-flex align-items-center">
                ...
                {{-- <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span id='count' class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">{{ $notifications->count() }}<span class="visually-hidden">unread messages</span></span>
                    </button>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                        ...
                        <div id="notification-list" class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                ...
                                <div id="" class="text-reset notification-item d-block dropdown-item position-relative">
                                    <div class="d-flex">
                                        <img src="{{$avatarUrl}}" class="me-3 rounded-circle avatar-xs flex-shrink-0" alt="user-pic">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form id="logout-form" action="{{ route('admin.logout.action') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                    </div>
                </div>
